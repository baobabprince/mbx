...
#all_results <- "Stool_maaslin_#2_DS-CD/all_results.tsv" |> 
all_results <- "Serum_maaslin_#2_DS-CD/all_results.tsv" |> 
...
# knitr::md("")
pl
ggsave(filename = "Serum_donut3.png", height = 10, width = 10)
```
